...
const ProductSearch = () => {
    ...
    return (
        <div className="m-25 m-h-520 base-container b-r-10 b-s-1-10 p-25">
                ...
                : (
                    productsResponse?.content.length !== 0 ?
                        ...
                        <div className="search-unsuccessful">
                            <p className="f-s-18">Sua busca por <b>"{productName}"</b> não correspondeu a nenhum produto :(</p>
                            <ul className="mt-2">
                                <li>Verifique se a palavra foi digitada corretamente;</li>
                                <li>Utilize palavras-chave mais genéricas, <b>por exemplo:</b> <u>Pentecostal</u>, ao invés de <i>Bíblia Pentecostal</i>, e <u>Blusa</u>, ao invés de <i>Blusas</i>.</li>
                            </ul>
                        </div>
                )}
            ...
            <a href="https://api.whatsapp.com/send?phone=5547000000000&text=Olá!%20Tenho%20dúvidas%20sobre%20um%20produto%20e/%20ou%20me%20interessei%20por%20um%20produto."
